...
namespace dbeckmann_2e1
{
    public partial class Form1 : Form
    {
        ...
        private void buttonCal_Click(object sender, EventArgs e)
        {
            ...
            //#12
            bool member12 = Convert.ToBoolean(input12aTextBox.Text);
            decimal price12 = Convert.ToDecimal(input12bTextBox.Text);
            float weight12 = Convert.ToSingle(input12cTextBox.Text);
            result12TextBox.Text = (
                LogicalOperations.q12(member12, price12, weight12)).ToString();

            //#13
            string shipState = input13aTextBox.Text;
            string itemType = input13bTextBox.Text;
            result13TextBox.Text = (
                LogicalOperations.q13(shipState, itemType)).ToString();
        }
