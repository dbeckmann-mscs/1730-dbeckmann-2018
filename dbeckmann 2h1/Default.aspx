<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="dbeckmann_2h1._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <asp:Label ID="Label4" runat="server" Text="4) DateTimeAddDays(90):"></asp:Label>
                <asp:TextBox ID="TextBox4Result" runat="server" Enabled="False"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="Label5" runat="server" Text="5) DateTimeAddMonths(3):"></asp:Label>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox6a" runat="server" Width="40px">2018</asp:TextBox>
                <asp:TextBox ID="TextBox6b" runat="server" Width="30px">2</asp:TextBox>
                <asp:TextBox ID="TextBox6c" runat="server" Width="30px">25</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox7" runat="server" Text="November 21, 2018"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox8" runat="server">November 21, 2018</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9a" runat="server" Width="80">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox9b" runat="server" Width="80" Text="12/12/2012"></asp:TextBox>
                <asp:TextBox ID="TextBox9Result" runat="server"></asp:TextBox>                
            </div>
            <div class="form-group">
                <asp:Label ID="Label10" runat="server" Text="10) DateA > DateB:"></asp:Label>
                <asp:TextBox ID="TextBox10a" runat="server" Width="80" Text="1/13/2013"></asp:TextBox>
                <asp:TextBox ID="TextBox10b" runat="server" Width="80" Text="12/12/2012"></asp:TextBox>
